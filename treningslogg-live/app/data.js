...
window.TL_DATA = (function () {
  ...
  // Nivå-tagger er valgfrie etiketter på instruktørledede økter; de
  // teller ikke i tema-balansen.
  ...
  const tags = [
    ...
    // Nivå (kun valgfri etikett på instruktørledede økter — telles ikke i tema-balanse)
    { id: 'grunn',        label: 'grunn',        kind: 'nivå',     core: false },
    { id: 'erfaren',      label: 'erfaren',      kind: 'nivå',     core: false },
    { id: 'mix',          label: 'mix',          kind: 'nivå',     core: false },
    { id: 'junior',       label: 'junior',       kind: 'nivå',     core: false },
  ];

  // sessions: dato (YYYY-MM-DD), tid, gruppe, trener, tittel, innhold, tags, oppmøte
  const sessions = [
    { id: 's-23', date: '2026-05-04', time: '18:00', group: 'gi',         trainer: 'ola',    title: 'half guard — underhook',
      ...
      tags: ['guard', 'half-guard', 'fundamentals', 'grunn'], attendance: 14 },
    { id: 's-22', date: '2026-04-30', time: '19:00', group: 'gi',         trainer: 'marius', title: 'leg lock entries — ashi garami',
      ...
      tags: ['submissions', 'leg-lock', 'erfaren'], attendance: 11 },
    { id: 's-21', date: '2026-04-28', time: '18:00', group: 'gi',         trainer: 'ola',    title: 'closed guard — kimura setup',
      content: 'kimura grip fra closed guard, sweep eller submission. partner-drill 3×5. avsluttet med åpen rolling 15 min.',
      tags: ['guard', 'submissions', 'kimura', 'closed-guard', 'grunn'], attendance: 14 },
    ...
    { id: 's-18', date: '2026-04-23', time: '19:00', group: 'gi',         trainer: 'marius', title: 'back take fra turtle',
      content: 'krabbe fra turtle, hooks in, body triangle. submission: rear naked choke + bow and arrow.',
      tags: ['back', 'submissions', 'takedowns', 'erfaren'], attendance: 12 },
    { id: 's-17', date: '2026-04-21', time: '18:00', group: 'gi',         trainer: 'ola',    title: 'mount — maintenance',
      content: 'high mount vs low mount. grapes, knee elbow, frame. hold-ned drill 2 min hver.',
      tags: ['mount', 'fundamentals', 'grunn'], attendance: 13 },
    ...
    { id: 's-14', date: '2026-04-16', time: '19:00', group: 'gi',         trainer: 'marius', title: 'half guard sweeps',
      content: 'old school sweep, plan b, deep half. drilling. kort sparring fra half guard.',
      tags: ['guard', 'half-guard', 'sweep', 'erfaren'], attendance: 10 },
    { id: 's-13', date: '2026-04-14', time: '18:00', group: 'gi',         trainer: 'ola',    title: 'side control escapes',
      content: 'escape til guard, escape til knees. frame, shrimp, bridge. live drill.',
      tags: ['sidekontroll', 'escapes', 'fundamentals', 'grunn'], attendance: 15 },
    ...
    { id: 's-10', date: '2026-04-09', time: '19:00', group: 'gi',         trainer: 'marius', title: 'guard passing — folding pass',
      content: 'folding pass, knee cut combo. drill og spesifikk sparring.',
      tags: ['passing', 'erfaren'], attendance: 11 },
    { id: 's-09', date: '2026-04-07', time: '18:00', group: 'gi',         trainer: 'ola',    title: 'closed guard maintenance',
      content: 'pummel, posture break, control sleeve+collar. introduksjon til scissor sweep.',
      tags: ['guard', 'closed-guard', 'fundamentals', 'grunn'], attendance: 12 },
  ];

  // planlagte fremtidige økter (uten innhold ennå)
  const planned = [
    { id: 'p-1', date: '2026-05-05', time: '19:00', group: 'gi',         trainer: 'ola' },
    { id: 'p-2', date: '2026-05-05', time: '20:30', group: 'gi',         trainer: 'marius', title: 'guard retention' },
    { id: 'p-3', date: '2026-05-07', time: '19:00', group: 'gi',         trainer: 'marius' },
    { id: 'p-4', date: '2026-05-09', time: '11:00', group: 'åpen matte', trainer: '' },
    { id: 'p-5', date: '2026-05-11', time: '18:00', group: 'gi',         trainer: 'ola' },
    { id: 'p-6', date: '2026-05-12', time: '17:00', group: 'junior',     trainer: 'kari' },
    { id: 'p-7', date: '2026-05-12', time: '19:00', group: 'gi',         trainer: 'marius' },
    { id: 'p-8', date: '2026-05-14', time: '19:00', group: 'gi',         trainer: 'marius' },
  ];
