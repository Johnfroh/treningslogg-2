...
window.TL_DATA = (function () {
  ...
  const tags = [
    // hovedkategorier (fast)
    { id: 'guard',       label: 'guard',       kind: 'guard' },
    { id: 'passing',     label: 'passing',     kind: 'guard' },
    { id: 'submission',  label: 'submission',  kind: 'submission' },
    { id: 'takedown',    label: 'takedown',    kind: 'dominant' },
    { id: 'escape',      label: 'escape',      kind: 'guard' },
    { id: 'sweep',       label: 'sweep',       kind: 'guard' },
    { id: 'control',     label: 'control',     kind: 'dominant' },
    // metode
    { id: 'drill',       label: 'drill',       kind: 'method' },
    { id: 'sparring',    label: 'sparring',    kind: 'method' },
    { id: 'fundamentals',label: 'fundamentals',kind: 'method' },
    // egne (skapt av trener)
    { id: 'kimura',      label: 'kimura',      kind: 'custom' },
    { id: 'closed-guard',label: 'closed guard',kind: 'custom' },
    { id: 'half-guard',  label: 'half guard',  kind: 'custom' },
    { id: 'leg-lock',    label: 'leg lock',    kind: 'custom' },
    { id: 'back-take',   label: 'back take',   kind: 'custom' },
    { id: 'mount',       label: 'mount',       kind: 'custom' },
  ];
  ...
  const sessions = [
    { id: 's-23', date: '2026-05-04', time: '18:00', group: 'grunnleggende', trainer: 'ola',    title: 'half guard — underhook',
      ...
      tags: ['guard', 'half-guard', 'fundamentals', 'drill'], attendance: 14 },
    { id: 's-22', date: '2026-04-30', time: '19:00', group: 'erfaren',       trainer: 'marius', title: 'leg lock entries — ashi garami',
      ...
      tags: ['submission', 'leg-lock'], attendance: 11 },
    { id: 's-21', date: '2026-04-28', time: '18:00', group: 'grunnleggende', trainer: 'ola',    title: 'closed guard — kimura setup',
      ...
      tags: ['guard', 'submission', 'kimura', 'closed-guard'], attendance: 14 },
    { id: 's-20', date: '2026-04-27', time: '17:00', group: 'junior',        trainer: 'kari',   title: 'fall + posisjon-spill',
      ...
      tags: ['fundamentals', 'control', 'drill'], attendance: 18 },
    ...
    { id: 's-18', date: '2026-04-23', time: '19:00', group: 'erfaren',       trainer: 'marius', title: 'back take fra turtle',
      ...
      tags: ['takedown', 'submission', 'back-take', 'control'], attendance: 12 },
    { id: 's-17', date: '2026-04-21', time: '18:00', group: 'grunnleggende', trainer: 'ola',    title: 'mount — maintenance',
      ...
      tags: ['control', 'mount', 'fundamentals'], attendance: 13 },
    ...
    { id: 's-14', date: '2026-04-16', time: '19:00', group: 'erfaren',       trainer: 'marius', title: 'half guard sweeps',
      ...
      tags: ['guard', 'sweep', 'half-guard'], attendance: 10 },
    { id: 's-13', date: '2026-04-14', time: '18:00', group: 'grunnleggende', trainer: 'ola',    title: 'side control escapes',
      ...
      tags: ['escape', 'fundamentals', 'drill'], attendance: 15 },
    { id: 's-12', date: '2026-04-13', time: '17:00', group: 'junior',        trainer: 'kari',   title: 'pinning posisjoner',
      ...
      tags: ['control', 'mount', 'fundamentals'], attendance: 14 },
    ...
    { id: 's-10', date: '2026-04-09', time: '19:00', group: 'erfaren',       trainer: 'marius', title: 'guard passing — folding pass',
      ...
      tags: ['passing', 'drill'], attendance: 11 },
    { id: 's-09', date: '2026-04-07', time: '18:00', group: 'grunnleggende', trainer: 'ola',    title: 'closed guard maintenance',
      ...
      tags: ['guard', 'closed-guard', 'sweep', 'fundamentals'], attendance: 12 },
  ];
